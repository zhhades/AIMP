package cn.neu.aimp.iot.constant.lib;

import cn.neu.aimp.iot.constant.common.ErrorCode;
import cn.neu.aimp.iot.constant.common.PaintPanel;
...
public class ToolKits {
	...
	public static String getErrorCodeShow() {
		return ErrorCode.getErrorCode(netsdkapi.CLIENT_GetLastError());
	}
