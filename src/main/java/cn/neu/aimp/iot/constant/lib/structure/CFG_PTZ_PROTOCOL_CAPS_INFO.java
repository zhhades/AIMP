...
import cn.neu.aimp.iot.constant.lib.enumeration.EM_SUPPORT_FOCUS_MODE;

import static cn.neu.aimp.iot.constant.lib.constant.SDKStructureFieldLenth.MAX_PROTOCOL_NAME_LEN;
...
public class CFG_PTZ_PROTOCOL_CAPS_INFO extends NetSDKLib.SdkStructure {
     ...
     * 云台辅助功能名称列表
     */
    public Auxs[] szAuxs = (Auxs[]) new Auxs().toArray(NetSDKLib.CFG_COMMON_STRING_32);
