 ...
 * @date 2020/12/21
 */
public class DEV_EVENT_TRAFFICACCIDENT_INFO extends NetSDKLib.SdkStructure {
	/**
	 * 通道号
	 */
	 ...
	 * 检测到的物体列表
	 */
	public NetSDKLib.NET_MSG_OBJECT[]      stuObjectIDs=(NetSDKLib.NET_MSG_OBJECT[])new NetSDKLib.NET_MSG_OBJECT().toArray(16);
	/**
	 * 事件对应文件信息
	 */
	 ...
	 * 交通车辆部分信息
	 */
	public NetSDKLib.EVENT_TRAFFIC_CAR_PART_INFO stuTrafficCarPartInfo;
	/**
	 * 车道号
	 */
	public int                nLane;              
