...
public class NET_POWER_STATUS extends NetSDKLib.SdkStructure {
     ...
     *  电源状态
     */
    public NET_POWER_INFO[] stuPowers = (NET_POWER_INFO[]) new NET_POWER_INFO().toArray(NetSDKLib.NET_MAX_POWER_NUM);
    /**
     *  电池数量
     */
     ...
     *  电池状态
     */
    public NET_BATTERY_INFO[] stuBatteries = (NET_BATTERY_INFO[]) new NET_BATTERY_INFO().toArray(NetSDKLib.NET_MAX_BATTERY_NUM);
