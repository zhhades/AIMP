 ...
 */
public class NET_RIOTERDETECTION_RULE_INFO extends NetSDKLib.SdkStructure {
    /**
     * 检测区域顶点数
     */
     ...
     */
    public  NetSDKLib.POINTCOORDINATE[]   stuMinDetectRect=(NetSDKLib.POINTCOORDINATE[]) new NetSDKLib.POINTCOORDINATE().toArray(2);
    /**
