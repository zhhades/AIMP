...
import cn.neu.aimp.iot.constant.lib.enumeration.NET_EM_SHAPE_TYPE;
...
public class NET_IN_SCENICSPOT_SETPOINTINFO_INFO extends NetSDKLib.SdkStructure {
     ...
     * 一级标题名称
     */
    public byte[] szTitleName = new byte[NetSDKLib.MAX_COMMON_STRING_64];
    /**
     * 一级标题名称类型
     */
     ...
     * 景物的轮廓,每个点依次表示轮廓顶点坐标
     */
    public NetSDKLib.DH_POINT[] stuPolygon = new NetSDKLib.DH_POINT[NetSDKLib.NET_MAX_POLYGON_NUM];
    /**
