...
import static cn.neu.aimp.iot.constant.lib.constant.SDKStructureFieldLenth.*;
...
public class CFG_HIGH_TOSS_DETECT_INFO extends NetSDKLib.SdkStructure {
  ...
  /** 相应物体类型列表 */
  public byte[] szObjectTypes = new byte[MAX_OBJECT_LIST_SIZE * NetSDKLib.MAX_NAME_LEN];
  /** 云台预置点编号 0~65535 */
